            ...
            <div class="form-bottom">
                 <form method="post" action="<?php echo base_url('index.php/auth/login'); ?>">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" placeholder="No NIK..." class="form-username form-control" id="form-username" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"//required>
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="form-password">Password</label>
                                        <input type="password" name="password" placeholder="No KK..." class="form-password form-control" id="form-password" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"//required>
                                    </div>
                                    <div class="form-group">
                                    <button class="btn btn-lg btn-primary btn-block" type="submit" class="tombol_login" value="LOGIN">Login</button></form>
                                    <a href="<?php echo base_url('index.php/Admin/login') ?>" type="button" class="btn btn-lg btn-primary btn-block">login admin</a>
                                    <a href="<?php echo base_url('index.php/register') ?>" type="button" class="btn btn-lg btn-primary btn-block">Daftar</a><br>
