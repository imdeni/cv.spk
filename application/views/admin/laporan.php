...
<div class="card-content blue-text text-darken-2" style="padding-top:10px; padding-right: 100px;padding-left: 100px;padding-bottom: 10px;">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="laporanfoto">
                                <img src="<?php echo base_url('assets/img/backgrounds/desa.png') ?>" width="100" height="100"></div>
                                <div class="laporan">
                                <p><center>PEMERINTAHAN KABUPATEN PEMALANG KECAMATAN PEMALANG</center></p>
                                <p><center>DESA WANAMULYA PEMALANG</center></p></div><hr>
                                <p><center>DAFTAR STATUS WARGA PENERIMA PKH</center></p>
                                <p style="font-size: 16px;">&nbsp&nbsp&nbspDicetak pada : <?php echo date('D,d-M-Y'); ?></p>
                                <div class="panel-body">
                                    
                                    <div class="table-responsive">
                                        <a target="_blank" style="font-size: 14px; color: black;" href="<?php echo base_url('index.php/smart/print'); ?>">
  <button>Print</button>
</a>
<br><br>
