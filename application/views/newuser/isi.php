						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li class="nav">
										<a href="<?php echo base_url('index.php/userbaru'); ?>">
									...
									<li class="nav">
										<a href="<?php echo base_url('index.php/userbaru/profile'); ?>">
											<i class="fa fa-info-circle" aria-hidden="true"></i>
											<span>Profile Desa</span>
										</a>
									</li>
									<li class="nav-active">
										<a href="<?php echo base_url('index.php/userbaru/isi'); ?>">
											<i class="fa fa-keyboard-o" aria-hidden="true"></i>
											<span>Isi Data Pengajuan</span>
										</a>
									</li>

									<li class="nav">
										<a href="<?php echo base_url('index.php/userbaru/hasil'); ?>">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Isi Data Pengajuan</span></li>
							</ol>
					...
					<div class="row">
						<div class="col-md-6 col-lg-12 col-xl-6">
							<section class="panel">
									...
									<?php $this->load->view('newuser/isiisi.php'); ?>
