...
<div class="card-content blue-text text-darken-2" style="padding-top:10px; padding-right: 100px;padding-left: 100px;padding-bottom: 10px;">
                        ...
                        <!-- Tabel Data -->
                        <div class="col-lg-12">
                            <p>Edit data <?php echo $a;?></p><br>
    <form action="" method="post">
    <label>Nama kriteria</label>
    <input type="text" name="namakriteria" value="<?php echo $a; ?>" /required><br>
    <label>Bobot kriteria</label>
    <input type="number" name="bobotkriteria" value="<?php echo $b; ?>" /required><br><br>
    ...
    if ($bobotkriteria >=1 && $bobotkriteria<=3) {
        ...
        if ($querysimpan) {
            ...
            location.assign('https://deniachmad.com/project-portofolio/spk/index.php/Admin/baru/kriteria');
            </script>";
        }else{
