...
<div class="card-content blue-text text-darken-2" style="padding-top:10px; padding-right: 100px;padding-left: 100px;padding-bottom: 10px;">
    ...
    <label style="color: black;width: 200px;">Nama sub 1</label>
    <input type="text" name="s1" value="<?php echo $a; ?>" placeholder="Nama sub 1" ><br>
    <label style="color: black;width: 200px;">Nilai Bobot 1</label>
    <input type="number" name="n1" value="<?php echo $b; ?>" placeholder="nilai bobot 1"><br>
    <label style="color: black;width: 200px;">Nama sub 2</label>
    <input type="text" name="s2" value="<?php echo $c; ?>" placeholder="Nama sub 2"><br>
    <label style="color: black;width: 200px;">Nilai Bobot 2</label>
    <input type="number" name="n2" value="<?php echo $d; ?>" placeholder="nilai bobot 2"><br>
    <label style="color: black;width: 200px;">Nama sub 3</label>
    <input type="text" name="s3" value="<?php echo $e; ?>" placeholder="Nama sub 3"><br>
    <label style="color: black;width: 200px;">Nilai Bobot 3</label>
    <input type="number" name="n3" value="<?php echo $f; ?>" placeholder="nilai bobot 3"><br><br>
    ...
    if ($n1 >=1 && $n1<=3 && $n2 >=1 && $n2<=3 && $n3 >=1 && $n3<=3) {
        ...
        if ($querysimpan) {
            ...
            location.assign('https://deniachmad.com/project-portofolio/spk/index.php/Admin/baru/sub');
            </script>";
        }else{
